			...
			<div class="col-md-6 col-md-offset-2">
				<div class="panel panel-inverse">
					...
					<div class="panel-body">
						<form method="POST" action="{{ url('mlevel/create') }}">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="myear" type="text" class="form-control" name="myear" placeholder="e.g. 1995 - 2010">
                        	</div>
						</div>
						<div class="form-group">
                            <label for="program" class="col-md-4 control-label">Program:</label>
                            <div class="col-md-6">
                                <input id="program" type="text" class="form-control" name="program" placeholder="Masters in ICT">
                        	</div>
						</div>
                   			<button type="submit" class="btn btn-success">Save</button>
                   			<a href="{{url('plevel/create')}}" class="btn btn-success" role="button">NEXT</a>
						</div>
							</form>
						</div>
				</div>
